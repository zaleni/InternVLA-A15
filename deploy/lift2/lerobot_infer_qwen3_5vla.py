...
from lerobot.policies.qwen3_5vla import Qwen3_5VLAConfig, Qwen3_5VLAPolicy
...
from lerobot.policies.qwen3_5vla.transform_qwen3_5vla import Qwen3_5ChatProcessorTransformFn
...
def main():
    ...
    # ckpt_path = Path(f"outputs/qwen3_5vla/2026_05_13_11_35_33-qwen3_5vla-lift2_pick_garbage-scratch-060000/pretrained_model")
    ...
    dtype = torch.float32
    assert isinstance(config, Qwen3_5VLAConfig)
    policy = Qwen3_5VLAPolicy.from_pretrained(
        config=config, 
    ...
    input_transforms = compose([
        ...
        Qwen3_5ChatProcessorTransformFn(), 
        PadStateTransformFn(
            max_state_dim=32,
        ),
