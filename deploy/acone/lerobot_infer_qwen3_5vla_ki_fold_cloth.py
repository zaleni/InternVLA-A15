...
def main():
    ...
    ckpt_path = Path("/home/pjlab/caijh/qwen3_5_vqa/lerobot_lab/outputs/qwen3_5vla_ki_wan/2026_06_08_05_34_43-qwen3_5vla_ki_wan-robotwin-delta-pretrain-300k-novideo-threefold/checkpoints/060000/pretrained_model")
    ...
    stats = load_json(ckpt_path / "stats.json")["arx_x5"]
